  ...
  return (
    <div className="about-us bg-[#0a0a0a] text-white py-16 px-8 flex flex-col justify-center items-center">
      <div className="container max-w-4xl mx-auto">
        ...
        <section className="intro mb-12 p-6 rounded-lg transition ease-in-out duration-300 hover:bg-[rgba(255,99,71,0.2)]">
        ...
        <section className="mission mb-12 p-6 rounded-lg transition ease-in-out duration-300 hover:bg-[rgba(70,130,180,0.2)]">
        ...
        <section className="what-we-do mb-12 p-6 rounded-lg transition ease-in-out duration-300 hover:bg-[rgba(34,193,195,0.2)]">
        ...
        <section className="approach mb-12 p-6 rounded-lg transition ease-in-out duration-300 hover:bg-[rgba(255,140,0,0.2)]">
        ...
        <section className="impact mb-12 p-6 rounded-lg transition ease-in-out duration-300 hover:bg-[rgba(255,223,186,0.2)]">
        ...
        <section className="team mb-12 p-6 rounded-lg transition ease-in-out duration-300 hover:bg-[rgba(0,255,127,0.2)]">
          ...
          <div className="team-grid grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="team-member text-center">
              ...
              <h6 className="text-xl font-bold">Jane Doe</h6>
              <p className="font-semibold">Founder & CEO</p>
              <p>Jane is a visionary leader with over 20 years of experience in the energy sector. She is dedicated to advancing sustainable energy practices and fostering innovation.</p>
            </div>
            <div className="team-member text-center">
              <img src="/images/usericon.png" alt="John Smith" className="w-16 h-16 mx-auto rounded-full mb-4" />
              <h6 className="text-xl font-bold">John Smith</h6>
              <p className="font-semibold">Lead Engineer</p>
              <p>John is a seasoned engineer with a passion for renewable energy. He leads our technical team, ensuring the highest quality in every project we undertake.</p>
            </div>
          </div>
        </section>

        <section className="join-us mb-12 p-6 rounded-lg transition ease-in-out duration-300 hover:bg-[rgba(255,165,0,0.2)]">
